...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" href="http://demo.devitems.com/furnilife-v1/furnilife/assets/images/logo.png">

	<!-- CSS
	============================================ -->
	<!-- Bootstrap CSS -->
	<link href="http://demo.devitems.com/furnilife-v1/furnilife/assets/css/bootstrap.min.css" rel="stylesheet">

	<!-- FontAwesome CSS -->
	<link href="http://demo.devitems.com/furnilife-v1/furnilife/assets/css/font-awesome.min.css" rel="stylesheet">

	<!-- Ionicons CSS -->
	<link href="http://demo.devitems.com/furnilife-v1/furnilife/assets/css/ionicons.min.css" rel="stylesheet">

	<!-- Plugins CSS -->
	<link href="http://demo.devitems.com/furnilife-v1/furnilife/assets/css/plugins.css" rel="stylesheet">

	<!-- Helper CSS -->
	<link href="http://demo.devitems.com/furnilife-v1/furnilife/assets/css/helper.css" rel="stylesheet">

	<!-- Main CSS -->
	<link href="http://demo.devitems.com/furnilife-v1/furnilife/assets/css/main.css" rel="stylesheet">

	<!-- Modernizer JS -->
	<script src="http://demo.devitems.com/furnilife-v1/furnilife/assets/js/vendor/modernizr-2.8.3.min.js"></script>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 mb-sm-30">
					...
					<div class="single-banner">
						<a href="shop-left-sidebar.html">
							<img src="http://demo.devitems.com/furnilife-v1/furnilife/assets/images/banners/banner1.jpg" class="img-fluid" alt="">
						</a>
				...
				<div class="col-lg-4 col-md-4 mb-sm-30">
					...
					<div class="single-banner">
						<a href="shop-left-sidebar.html">
							<img src="http://demo.devitems.com/furnilife-v1/furnilife/assets/images/banners/banner2.jpg" class="img-fluid" alt="">
						</a>
						<div class="text-content">
				...
				<div class="col-lg-4 col-md-4">
					...
					<div class="single-banner">
						<a href="shop-left-sidebar.html">
							<img src="http://demo.devitems.com/furnilife-v1/furnilife/assets/images/banners/banner3.jpg" class="img-fluid" alt="">
						</a>
						<div class="text-content">
...
<div class="tab-product-slider-container mb-50">
						...
						<nav>
							<div class="nav nav-tabs" id="nav-tab" role="tablist">
								...
								<a class="nav-item nav-link" id="nav-onsale-tab" data-toggle="tab" href="#on-sale" role="tab"
									aria-selected="false">Onsale Products</a>
							</div>
						</nav>
							...
							<div class="tab-pane fade show active" id="featured" role="tabpanel" aria-labelledby="featured-tab">
								...
								<div class="fl-slider tab-product-slider">
									...
									<div class="fl-product">
										...
										<div class="content">
											<h2 class="product-title"> <a href="single-product.html">{{ $product->name }}</a></h2>
											<div class="rating">
					...
					<div class="col-lg-4 col-md-6">
						...
						<div class="address-block">
							...
							<div class="social-links">
								<ul>
									<li><a href="//www.twitter.com" class="twitter"  data-tooltip="Twitter"><i class="fa fa-twitter"></i></a></li>
									<li><a href="//www.facebook.com" class="facebook"  data-tooltip="Facebook"><i class="fa fa-facebook"></i></a></li>
									<li><a href="//www.behance.com" class="behance" data-tooltip="Behance"><i class="fa fa-behance"></i></a></li>
									<li><a href="//www.pinterest.com" class="pinterest" data-tooltip="Pinterest"><i class="fa fa-pinterest"></i></a></li>
									<li><a href="//www.rss.com" class="rss" data-tooltip="RSS"><i class="fa fa-rss"></i></a></li>
								</ul>
							</div>
						</div>
	...
	============================================ -->
	<!-- jQuery JS -->
	<script src="http://demo.devitems.com/furnilife-v1/furnilife/assets/js/vendor/jquery.min.js"></script>

	<!-- Popper JS -->
	<script src="http://demo.devitems.com/furnilife-v1/furnilife/assets/js/popper.min.js"></script>

	<!-- Bootstrap JS -->
	<script src="http://demo.devitems.com/furnilife-v1/furnilife/assets/js/bootstrap.min.js"></script>

	<!-- Plugins JS -->
	<script src="http://demo.devitems.com/furnilife-v1/furnilife/assets/js/plugins.js"></script>

	<!-- Main JS -->
	<script src="http://demo.devitems.com/furnilife-v1/furnilife/assets/js/main.js"></script>
